...
angular.module('web2App')
  .service('appData', function ($rootScope, $http) {
    ...
    var pathData;
    // Paths
    $http.get('http://localhost:3000/coords/').then(function (res) {
      pathData = res.data;
    });
    ...
    // Bikes
    $http.get('http://localhost:3000/bikes/').then(function (res) {
      bikeList = res.data;
      bikeSelection = bikeList;
    ...
    var getBikePath = function (id) {
      return pathData[id].map(function (point) {
